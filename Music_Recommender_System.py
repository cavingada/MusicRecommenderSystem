...
#@author: Cavin Gada
#@project: Music Recommender System. Uses Text file named "Musicrecplus.txt" for all operations.

"""
The MRS (python file) uses a text file named "musicrecplus" that stores a database of users and their preferences.
My MRS allows users to interact (using a simplistic and easy to understand UI) with this database by entering their preferences,
finding popular artists, which users have the most preferences, etc. This project implements certain concepts like loading, writing, and reading
text files, storing data from information in the database, cleaning information in the database, etc. Additionally, some basic algorithms to 
find popular artists, etc. are implemented. Feel free to play around with the musicrecplus text file and command prompts in the shell once your run this file!
"""
